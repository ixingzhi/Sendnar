...
/**
 * Created by xiedd on 2018/1/15.
 * 星级评分
 */

public class RxRatingBar extends LinearLayout {
    /**
     * 是否可点击
     */
     ...
     * @param attrs
     */
    public RxRatingBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        setOrientation(LinearLayout.HORIZONTAL);
        TypedArray mTypedArray = context.obtainStyledAttributes(attrs, R.styleable.RxRatingBar);
        starImageSize = mTypedArray.getDimension(R.styleable.RxRatingBar_starImageSize, 20);
        starPadding = mTypedArray.getDimension(R.styleable.RxRatingBar_starPadding, 10);
        starStep = mTypedArray.getFloat(R.styleable.RxRatingBar_starStep, 1.0f);
        stepSize = StepSize.fromStep(mTypedArray.getInt(R.styleable.RxRatingBar_stepSize, 1));
        starCount = mTypedArray.getInteger(R.styleable.RxRatingBar_starCount, 5);
        starEmptyDrawable = mTypedArray.getDrawable(R.styleable.RxRatingBar_starEmpty);
        starFillDrawable = mTypedArray.getDrawable(R.styleable.RxRatingBar_starFill);
        starHalfDrawable = mTypedArray.getDrawable(R.styleable.RxRatingBar_starHalf);
        mClickable = mTypedArray.getBoolean(R.styleable.RxRatingBar_clickable, true);
        mTypedArray.recycle();
