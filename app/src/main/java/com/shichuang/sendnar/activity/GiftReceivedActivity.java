...
public class GiftReceivedActivity extends BaseActivity {
    ...
    private int giftStatus = GiftStatus.HAS_RECEIVE;
    ...
    public void initView(Bundle savedInstanceState, View view) {
        ...
        mTabLayout.addTab(mTabLayout.newTab().setText("待处理"));
        mTabLayout.addTab(mTabLayout.newTab().setText("已转赠"));
        RxTabLayoutTool.setIndicator(mContext, mTabLayout, 40, 40);

        mEmptyLayout = (RxEmptyLayout) findViewById(R.id.empty_layout);
        mSwipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.swipe_refresh_layout);
        mRecyclerView = (RecyclerView) findViewById(R.id.recycler_view);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(this));
        mAdapter = new GiftReceivedAdapter();
    ...
    private void isShowRemind() {
        if (Setting.isShowGiftsReceiveRemind(mContext)) {
            GiftsReceiveRemindDialog mDialog = new GiftsReceiveRemindDialog(mContext);
            mDialog.show();
        }
    }
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                switch (tab.getPosition()) {
                    case 0:
                        ...
                        break;
                    case 1:
                        giftStatus = GiftStatus.HAS_EXAMPLES;
                        break;
                }
    ...
    private void getActionData() {
        OkGo.<AMBaseDto<LookGiftInfo>>get(Constants.lookGiftInfoUrl)
                ...
                .params("operation_type", 2)   // 1 发送的礼物 2 接收的礼物
    ...
    private void share(int redPacketId, String greetings, String description, String imgShareUrl, int type) {
        ...
        final ShareDialog mDialog = new ShareDialog(GiftReceivedActivity.this);
