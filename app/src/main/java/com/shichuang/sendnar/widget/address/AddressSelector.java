...
public class AddressSelector extends LinearLayout implements View.OnClickListener {
            ...
            holder.itemView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if (onItemClickListener != null) {
                        onItemClickListener.itemClick(AddressSelector.this, (CityInterface) v.getTag(), position, tabIndex);
    ...
    public static final int LOADING = 0x11;
    public static final int SUCCESS = 0x12;
    public static final int FAIL = 0x13;
    public static final int HIDE = 0x14;
