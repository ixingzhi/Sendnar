...
//        params.height = height;
    ...
    private void initRecyclerView() {
        ...
        mAdapter = new GiftsCategoryType3Adapter();
    ...
    public void initEvent() {
        ...
        mAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                bundle.putInt("id", Integer.valueOf(mAdapter.getData().get(position).getGiftId()));
                ...
                .execute(new NewsCallback<AMBaseDto<GiftsCategoryType2>>() {
                    ...
                    public void onSuccess(final Response<AMBaseDto<GiftsCategoryType2>> response) {
                        if (response.body().code == 0) {
                            // 商品列表
                            GiftsCategoryType2.PackageList table = response.body().data.getPackageList();
    ...
    private void setData(List<GiftsCategoryType2.PackageList.PackageListModel> data) {
